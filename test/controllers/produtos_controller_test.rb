...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { assai: @produto.assai, atacadao: @produto.atacadao, embalagem: @produto.embalagem, nome: @produto.nome, walmart: @produto.walmart } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { assai: @produto.assai, atacadao: @produto.atacadao, embalagem: @produto.embalagem, nome: @produto.nome, walmart: @produto.walmart } }
